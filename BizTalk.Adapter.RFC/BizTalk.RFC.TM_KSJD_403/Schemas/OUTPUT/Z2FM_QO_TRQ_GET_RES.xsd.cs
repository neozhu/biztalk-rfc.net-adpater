namespace BizTalk.RFC.TM_KSJD_403.Schemas.OUTPUT {
    ...
    [Schema(@"http://BizTalk.RFC.Schemas.INPUT.Z2FM_QO_TRQ_CRT",@"Z2FM_QO_TRQ_GET_RES")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"Z2FM_QO_TRQ_GET_RES"})]
    public sealed class Z2FM_QO_TRQ_GET_RES : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns=""http://BizTalk.RFC.Schemas.INPUT.Z2FM_QO_TRQ_CRT"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" elementFormDefault=""qualified"" targetNamespace=""http://BizTalk.RFC.Schemas.INPUT.Z2FM_QO_TRQ_CRT"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""Z2FM_QO_TRQ_GET_RES"">
    <xs:complexType>
      <xs:sequence>
          ...
          <xs:complexType>
            <xs:sequence>
              ...
              <xs:element minOccurs=""0"" maxOccurs=""unbounded"" name=""ZTD"">
                <xs:complexType>
                  <xs:sequence>
                    <xs:element minOccurs=""0"" name=""ZTD"">
                      <xs:complexType>
                        <xs:sequence>
                          <xs:element name=""KEY"" type=""xs:base64Binary"" />
                    ...
                    <xs:element minOccurs=""0"" maxOccurs=""unbounded"" name=""ZTD_SRV_TYPE"">
                      <xs:complexType>
                        <xs:sequence>
                          <xs:element name=""KEY"" type=""xs:base64Binary"" />
                          <xs:element name=""ROOT_KEY"" type=""xs:base64Binary"" />
                          <xs:element name=""REF_SRV_KEY"" type=""xs:base64Binary"" />
        ...
        <xs:element maxOccurs=""unbounded"" name=""ET_RELATION_FUTU"">
          <xs:complexType>
            <xs:sequence>
              <xs:element name=""TRQ_KEY"" type=""xs:base64Binary"" />
              <xs:element name=""TRQ_ID"" type=""xs:string"" />
              <xs:element name=""TOR_KEY"" type=""xs:base64Binary"" />
              <xs:element name=""TOR_ID"" type=""xs:string"" />
            </xs:sequence>
          </xs:complexType>
        </xs:element>
        <xs:element maxOccurs=""unbounded"" name=""ET_RELATION_FOFB"">
          <xs:complexType>
            <xs:sequence>
              <xs:element name=""TRQ_KEY"" type=""xs:base64Binary"" />
              <xs:element name=""TRQ_ID"" type=""xs:string"" />
        ...
        <xs:element minOccurs=""0"" name=""ES_FAG"">
          <xs:complexType>
            <xs:sequence>
              <xs:element name=""FAG_KEY"" type=""xs:base64Binary"" />
              <xs:element name=""FAGRMNTID044"" type=""xs:string"" />
              <xs:element name=""MNEMONIC"" type=""xs:string"" />
              <xs:element name=""FAG_ITEM_KEY"" type=""xs:base64Binary"" />
              <xs:element name=""ITEM_NO"" type=""xs:string"" />
            </xs:sequence>
          </xs:complexType>
        </xs:element>
        <xs:element minOccurs=""0"" maxOccurs=""unbounded"" name=""ET_TOR"">
          <xs:complexType>
            <xs:sequence>
              <xs:element name=""ROOT"">
                <xs:complexType>
        ...
        public override string[] RootNodes {
            get {
                ...
                _RootElements[0] = "Z2FM_QO_TRQ_GET_RES";
